...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://chatonline.orane.com", "http://localhost:8000", "http://127.0.0.1:8000", "http://localhost:8001", "https://deluxe-begonia-de9a11.netlify.app"],
...
try:
    ...
    # Parse credentials from the environment variable string
